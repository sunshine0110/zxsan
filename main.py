...
def title():
	...
	-TCP (tcp attck)
	-UDP (udp attack)
	-CFB (cloudflare bypass attack
\033[0m """)
##############################################################################################
def command():
    stdout.write(Fore.LIGHTCYAN_EX+"╔═══"+Fore.GREEN+"[""zxsan"+Fore.RED+"@"+Fore.LIGHTCYAN_EX+"FLOODER"+Fore.CYAN+"]"+Fore.RED+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
